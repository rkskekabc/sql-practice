...
-- 보세요.
select first_name as "이름", gender as "성별", hire_date as "입사일" from employees order by hire_date desc; 
...
select title, from_date, to_date from titles where emp_no = 13250 and to_date;